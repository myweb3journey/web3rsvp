...
const main = async () => {
    ...
    // Creating a new event. Before calling this method must define event data: 
    ...
    let eventID = wait.events[0].eventID;
    console.log("EVENT ID: ", eventID);

    // Have each hardhat test account create a new RSVP to the event: 
    ...
    // Confirm all of the RSVP w/ confirmAllAttendees:
